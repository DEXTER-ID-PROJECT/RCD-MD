...
const Handler = async (chatUpdate, sock, logger) => {
    try {
        ...
        // Determine the appropriate plugin directory based on MENU_TYPE
        const menuType = config.MENU_TYPE;  // Get the menu type from env
        const pluginDir = path.join(__dirname, '..', menuType === 'button' ? 'plugin' : 'normal');
